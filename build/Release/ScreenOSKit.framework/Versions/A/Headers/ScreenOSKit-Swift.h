...
#ifndef SCREENOSKIT_SWIFT_H
#define SCREENOSKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScreenOSKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ScreenOSKit25PreferencesViewController")
...
SWIFT_CLASS("_TtC11ScreenOSKit16ShortcutRecorder")
...
SWIFT_CLASS("_TtC11ScreenOSKit12SwitcherCell")
@interface SwitcherCell : NSCollectionViewItem
- (void)loadView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC11ScreenOSKit13SwitcherPanel")
@interface SwitcherPanel : NSWindow
...
@class NSIndexPath;
@interface SwitcherPanel (SWIFT_EXTENSION(ScreenOSKit)) <NSCollectionViewDataSource, NSCollectionViewDelegate>
